    ...
    public class AutomapperProfiles: Profile
    {
        public AutomapperProfiles(GeometryFactory geometryFactory)
        {
            ...
            CreateMap<ActorCreacionDTO, Actor>()
                .ForMember(x=> x.Foto,options => options.Ignore()); //por el momento ignoraremos la foto, se tratara de una manera especial

            CreateMap<CineCreacionDTO, Cine>()
                .ForMember(x => x.Ubicacion, x => x.MapFrom(dto =>
                geometryFactory.CreatePoint(new Coordinate(dto.Longitud, dto.Latitud))));

            CreateMap<Cine, CineDTO>() //mapear individualmente latitud y longitud
        ...
        //mapeo para el detalle de la pelicula
